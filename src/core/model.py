...
class BaseModel(object):
    ...
    def _build_all_models(self):
        ...
        # why here use self? we can still define it in __init__
        self.output_tensors = {}
        self.loss_terms = {}
        self.metrics = {}
        ...
        def _build_train_or_test(mode):
            ...
            self.output_tensors[mode] = output_tensors # the predicted labels
    ...
    def train_loop_pre(self, current_step):
        ...
        multiplier = np.power(0.1, int(current_step / 60000))
    ...
    def train(self, num_epochs=None, num_steps=None):
        ...
        if num_steps is None:
            ...
            # debug
            logger.info("Total entries {} x {} / {} ".format(num_entries, num_epochs, self._batch_size))
        ...
        try:
            ...
            for current_step in range(initial_step, num_steps):
                ...
                if current_step % 9000 == 0:
                    self.train_loop_pre(60000)
                if current_step % 60000 == 0:
                ...
                self.time.log_every('train_iteration', to_print, seconds=60)

                # Trigger copy weights & concurrent testing (if not already running)
                if self._enable_live_testing and current_step % 3000 == 0 and current_step != 0:
    ...
    def evaluate_for_submission(self, data_source):
        ...
        # Write predictions to file, .gz compressed file
